...
def SIGBED2019(DATA, TOPO, NUM_FLOW, INS=-1, OUTPUT="./", workers=1):
    try:
        # utils.mem_start()
        ...
        utils.write_result(utils.myname(), DATA, GCL, OFFSET_out, ROUTE, QUEUE,
                           DELAY, OUTPUT)

        # run_memory = utils.mem_log()

        return utils.rprint(INS, NUM_FLOW, "sat", end_time - start_time)
    except KeyboardInterrupt:
        return utils.rprint(INS, NUM_FLOW, "unknown", end_time - start_time)
...
if __name__ == "__main__":
    ...
    SIGBED2019(DATA, TOPO, var, ins, workers=4)